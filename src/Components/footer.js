                      ...
                      <div class="row footer-top-wrap">
                          <div class="col-md-4 col-sm-6">
                              <div class="footer-nav-wrap text-white">
                                  ...
                                  <p>AEJ Digital Marketing, is the best Digital Marketing Agency, is there for you, to grow your business, to get more sales & expansion worldwide.</p>
                                  <div class="social-nav mt-4">
                                      <ul class="list-unstyled social-list mb-0">
                                          ...
                                          <li class="list-inline-item tooltip-hover"><a href="#" class="rounded"><span
                                              class="ti-dribbler"></span></a>
                                              <div class="tooltip-item">Dribble</div>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                              ...
                              <div class="footer-nav-wrap text-white">
                                  ...
                                  <ul class="get-in-touch-list">
                                      <li class="d-flex align-items-center py-2"><span
                                          class="fas fa-map-marker-alt mr-2"></span> 173/222 Roshanbagh Khuldabad, Prayagraj, India
                                      </li>
                                      <li class="d-flex align-items-center py-2"><span
